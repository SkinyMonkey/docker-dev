...
func main() {
	...
	// attach to the container by executin docker attach
	...
	if resp, err = cli.ContainerCreate(ctx, containerJSON.Config, containerJSON.HostConfig, &networkingConfig, nil, containerJSON.Name); err != nil {
